...
const ContactDetailsSVG = (props: SvgProps) => (
  <Svg width={160} height={80} viewBox="0 0 160 80" fill="none" {...props}>
    <Ellipse cx={81.1503} cy={40} rx={39.8756} ry={40} fill="url(#paint0_linear_1111_18102)" />
    ...
    <G filter="url(#filter1_dd_1111_18102)">
      ...
      <Rect
        ...
        strokeOpacity={0.03}
      />
      <Rect x={55} y={34} width={49} height={6} rx={3} fill="#BDBDBD" />
      <Rect x={55} y={45} width={56} height={6} rx={3} fill="#EEE" />
      <Rect x={55} y={24} width={55} height={6} rx={3} fill="#BDBDBD" />
      <Rect x={55.5} y={24.5} width={54} height={5} rx={2.5} stroke="#fff" strokeOpacity={0.31} />
      <Circle cx={32} cy={38} r={14} fill="#FAFAFA" />
