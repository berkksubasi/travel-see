...
type IListItemAvatarCornerImageProps = Omit<IListItemAvatarProps, 'children' | 'cornerIconProps'>
    ...
    <Stack {...rest} justifyContent={getJustifyContent()}>
      ...
      {secondary &&
        (isValidElement(secondary) ? (
          ...
          <Text variant="$bodyMd" tone="subdued" textAlign={align} {...secondaryTextProps}>
            {secondary}
          </Text>
        ))}
    </Stack>
...
// Separator
const ListItemSeparator = () => <Divider marginHorizontal="$5" />
...
function ListItem(props: IListItemProps) {
  ...
  return (
    ...
    >
      {avatarProps && (
        <ListItemAvatar {...(!avatarProps.circular && { borderRadius: '$2' })} {...avatarProps} />
      )}
      ...
      {children}
      {drillIn && <Icon name="ChevronRightSmallOutline" color="$iconSubdued" marginHorizontal="$-1.5" />}
      <Unspaced>
