const restrictedImportPaths = [
    {
        ...
        message: [
            '',
            "For 'useWindowDimensions', please use 'hooks/useWindowDimensions' instead.",
    ...
    },
    {
        ...
        message: "Please use 'useSafeAreaInsets' from 'hooks/useSafeAreaInset' and/or 'SafeAreaConsumer' from 'components/SafeAreaConsumer' instead.",
    },
    {
        name: 'react',
...
module.exports = {
    ...
    parser: 'babel-eslint',
    ignorePatterns: ['!.*', 'vendor', '.github/actions/**/index.js', 'desktop/dist/*.js', 'dist/*.js', 'node_modules/.bin/**', 'node_modules/.cache/**', '.git/**'],
    env: {
        jest: true,
    },
    globals: {
